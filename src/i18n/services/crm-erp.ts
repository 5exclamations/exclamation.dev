...
export const crmErp: Record<Locale, ServiceCopy> = {
  ...
  ru: {
    ...
    intro: [
      'Почти каждый разговор о CRM начинается с одного вопроса: брать готовое или писать своё. Честный ответ — чаще всего берите готовое. amoCRM, Bitrix24 и подобные запускаются за неделю, стоят предсказуемых денег и закрывают воронку «лид — звонок — сделка» лучше, чем что угодно написанное с нуля за тот же срок.',
      ...
      'Зато старт дольше, а для развития нужна техническая команда. Мы это не прячем: ниже отдельный раздел о том, когда CRM вам не нужна вовсе.',
    ...
    notFor: {
      ...
      items: [
        ...
        },
        {
          ...
          text: 'CRM нужна, чтобы информация не терялась между людьми. Когда человек один — теряться негде: коробка выйдет дешевле и быстрее.',
        },
        {
        ...
        },
        {
          ...
          text: 'Если процесс совпадает с моделью amoCRM или Bitrix24, писать своё незачем — увидим это на брифе, скажем сами и предложим настройку вместо разработки.',
        },
      ],
      ...
      items: [
        {
          ...
          a: 'Часто да, и мы говорим это прямо. Готовая CRM дорожает тогда, когда процесс в неё не влезает: плагины, интегратор, подписка, растущая с каждым пользователем. На брифе считаем оба варианта — готовую CRM и разработку на заказ — и показываем разницу.',
        },
        {
